    ...
    if args.dataset in ['VOT2016', 'VOT2018', 'VOT2019', 'OTB100']:
        ...
        for v_idx, video in enumerate(dataset):
            ...
            for i in range(0, args.epochs):
                ...
                print('({:3d}) Video: {:12s} train{}/{} Time: {:4.1f}s Speed: {:3.1f}fps Lost: {:d}'.format(
                    v_idx + 1, video.name, i, args.epochs, toc, idx / toc, lost_number_adv))
            ...
            print('({:3d}) Video: {:12s} Time Average: {:4.1f}s Speed Average: {:3.1f}fps Lost: {:d}'.format(
                    v_idx+1, video.name, total_toc, idx / total_toc, lost_number_adv))
